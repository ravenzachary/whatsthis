...
1. Unzip "whatsthis.zip" to a folder on your computer
...
Just browse normally:
  ...
  - SELECT any text → wait 1 second → info appears
  - HOVER over an image or video → wait 1.5 seconds → analysis appears
  - RIGHT-CLICK anything → "What's This?" in the menu
...
https://github.com/ravenzachary/whatsthis
